...
var mainUrl = "https://www.rottentomatoes.com/top/bestofrt/?year=2019"
...
class TableViewController: UITableViewController {
    ...
    func dataCrawling(){
        ...
        do {
            ...
            for title in doc.xpath("//*[@id='top_movies_main']/div/table/tr/td/a"){
                let rowData = ("\(count) : " + title.text!.trimmingCharacters(in: .whitespacesAndNewlines), title["href"]!)
                movies.append(rowData)
                count += 1
            }
        }catch let error{
            print("Error: \(error)")
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let indexPath = self.tvMovies.indexPath(for: cell)
        
        let detailView = segue.destination as! DetailViewController
        detailView.inputUrl(url: "https://www.rottentomatoes.com\(movies[indexPath!.row].1)")
    }
